...
const i18nData = {
  ja: {
    ...
    'tax-incl': '（税込）',
    'course-note': '※季節や仕入れ状況により、内容は変更となる場合がございます。',
    'course-a-i1': '寿司 10貫',
    'course-a-i2': '巻物',
    'course-a-i3': 'お椀',
    'course-a-i4': 'デザート',
    ...
    'info-hours-val': '昼（要予約）12:00〜14:00　<small>※月・火・金・土・日のみ</small><br>夜 17:00〜22:30（LO 22:00）<br>金・土曜日 17:00〜24:00（食事LO 23:00 / ドリンクLO 23:30）',
  ...
  en: {
    ...
    'course-note': '* Contents may change depending on seasonal availability and sourcing.',
    'course-a-i1': 'Nigiri  10 pieces',
    'course-a-i2': 'Roll',
    'course-a-i3': 'Soup',
    'course-a-i4': 'Dessert',
    'course-b-i1': '3 seasonal dishes',
    'course-b-i2': 'Nigiri  10 pieces',
    'course-b-i3': 'Soup',
    'course-b-i4': 'Dessert',
    'course-c-i1': '6 seasonal dishes',
    'course-c-i2': 'Nigiri  10 pieces',
    'course-c-i3': 'Soup',
    'course-c-i4': 'Dessert',
    ...
    'info-hours-val': 'Lunch (reservation req.): 12:00–14:00 <small>Mon, Tue, Fri, Sat & Sun only</small><br>Dinner Mon–Thu, Sun: 17:00–22:30 (LO 22:00)<br>Fri & Sat: 17:00–24:00 (Food LO 23:00 / Drinks LO 23:30)',
  ...
  'zh-cn': {
    ...
    'tax-incl': '（含税）',
    'course-note': '※ 内容可能会根据季节和食材采购情况有所变动。',
    'course-a-i1': '握寿司 10贯',
    'course-a-i2': '卷物',
    'course-a-i3': '汤品',
    'course-a-i4': '甜点',
    ...
    'info-hours-val': '午餐（需预约）：12:00〜14:00　<small>※周一、二、五、六、日</small><br>晚餐 周一至四、周日：17:00〜22:30（最后点餐 22:00）<br>周五、六：17:00〜24:00（料理 23:00 / 饮品 23:30）',
  ...
  'zh-tw': {
    ...
    'tax-incl': '（含稅）',
    'course-note': '※ 內容可能會依季節與食材採購狀況有所變動。',
    'course-a-i1': '握壽司 10貫',
    'course-a-i2': '卷物',
    'course-a-i3': '湯品',
    'course-a-i4': '甜點',
    ...
    'info-hours-val': '午餐（需預約）：12:00〜14:00　<small>※週一、二、五、六、日</small><br>晚餐 週一至四、週日：17:00〜22:30（最後點餐 22:00）<br>週五、六：17:00〜24:00（料理 23:00 / 飲品 23:30）',
...
const weeklyMenu = {
  lunch: [
    { ja: '寿司 10貫', en: 'Nigiri  10 pieces', cn: '握寿司 10贯', tw: '握壽司 10貫' },
    { ja: '巻物',      en: 'Roll',              cn: '卷物',        tw: '卷物' },
  ...
  courseB: [
    { ja: 'お料理 3品', en: '3 seasonal dishes', cn: '季节料理 3品', tw: '季節料理 3品' },
    { ja: '寿司 10貫',  en: 'Nigiri  10 pieces', cn: '握寿司 10贯',  tw: '握壽司 10貫' },
    { ja: 'お椀',       en: 'Soup',              cn: '汤品',         tw: '湯品' },
    { ja: 'デザート',   en: 'Dessert',           cn: '甜点',         tw: '甜點' },
  ],
  courseC: [
    { ja: 'お料理 6品', en: '6 seasonal dishes', cn: '季节料理 6品', tw: '季節料理 6品' },
    { ja: '寿司 10貫',  en: 'Nigiri  10 pieces', cn: '握寿司 10贯',  tw: '握壽司 10貫' },
    { ja: 'お椀',       en: 'Soup',              cn: '汤品',         tw: '湯品' },
    { ja: 'デザート',   en: 'Dessert',           cn: '甜点',         tw: '甜點' },
  ],
